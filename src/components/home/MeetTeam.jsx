...
const TeamMember = ({ name, role, image, delay, linkedin, github }) => (
    ...
    >
        <div className="relative mb-6 inline-block">
            ...
            <a href={linkedin} target="_blank" rel="noopener noreferrer" className="absolute -bottom-2 -right-2 bg-adorix-primary text-white p-2 rounded-full scale-0 group-hover:scale-100 transition-transform duration-500 block">
        ...
        <div className="flex justify-center gap-4">
            <a href={github} target="_blank" rel="noopener noreferrer" className="flex">
